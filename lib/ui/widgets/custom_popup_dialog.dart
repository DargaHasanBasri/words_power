          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                'korunmaktadır.Biz, Şirket Adı, veri sorumlusu olarak,'
                ' bu gizlilik ve kişisel verilerin korunması politikası '
                'ile, hangi kişisel verilerinizin hangi amaçla işleneceği,'
                ' işlenen verilerin kimlerle ve neden paylaşılabileceği,'
                ' veri işleme yöntemimiz ve hukuki sebeplerimiz ile; '
              ...
              Text(
                ...
                ' şekilde yerine getirebilmek, bu hizmetlere sizin'
                ' tarafınızdan ulaşılabilmesini ve maksimum düzeyde'
                ' faydalanılabilmesini sağlamak, hizmetlerimizi,'
                ' ihtiyaçlarınız doğrultusunda geliştirebilmek ve sizleri'
                ' daha geniş kapsamlı hizmet sağlayıcıları ile yasal'
                ' çerçeveler içerisinde buluşturabilmek ve kanundan doğan'
                ' zorunlulukların (kişisel verilerin talep halinde adli ve'
                ' idari makamlarla paylaşılması) yerine getirilebilmesi'
              ...
              Text(
                ...
                ' niteliğini, yasalar çerçevesinde belirlemekte tamamen'
                ' serbest olup; hizmetlere ilişkin yapacağımız'
              ...
              const SizedBox(height: 10),
              Text(
                "UYGULAMADA'de yayınlanan tüm metin, kod, grafikler, logolar,"
                ' resimler, ses dosyaları ve kullanılan yazılımın sahibi'
                ' (bundan böyle ve daha sonra "içerik"'
                ' olarak anılacaktır) Şirket Adı olup, tüm hakları'
              ...
              Text(
                ...
                ' için elimizden geleni yapmaktayız. Lakin gösterdiğimiz'
                ' çabaya rağmen, bu bilgiler, fiili değişikliklerin'
                ' gerisinde kalabilir, birtakım farklılıklar olabilir.'
                ' Bu sebeple, site içerisinde yer alan bilgilerin doğruluğu'
                ' ve güncelliği ile ilgili tarafımızca, açık veya zımni,'
              ...
              Text(
                ...
                ' ve platformlara köprüler (hyperlink) bulunabilir.'
                ' SİTE, işlevsellik yalnızca bu sitelere ulaşımı sağlamakta'
              ...
              Text(
                ...
                ' sadece gerekli olan kişisel verilerinizin, işbu gizlilik'
                ' ve kişisel verilerin işlenmesi politikası uyarınca'
                ' işlenmesini, kabul edip etmemek hususunda tamamen'
                ' özgürsünüz. Siteyi kullanmaya devam ettiğiniz takdirde'
                ' kabul etmiş olduğunuz tarafımızca varsayılacak olup,'
                ' daha ayrıntılı bilgi için bizimle email@site.com e-mail'
